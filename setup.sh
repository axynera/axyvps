...
# ====================================================================
# 2. HAPUS KONFLIK DROPBEAR & INSTALL DEPENDENCY
# ====================================================================
echo "[+] Update repository & hapus paket SSH bawaan yang bentrok..."
apk update && apk upgrade
apk del dropbear dropbear-ssh 2>/dev/null || true
...
'  OS Environment   : Alpine Linux Enterprise (ARM64 Cloud)' \
...
'--------------------------------------------------------------------' \
'  SECURITY WARNING:' \
'  - Root access level: ADMIN PRIVILEGES' \
'  - DDoS attacks, crypto mining, and torrenting are monitored' \
'    and will result in instant node suspension.' \
'====================================================================' > /etc/motd
